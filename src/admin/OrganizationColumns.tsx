    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex items-center gap-2">
          ...
          {isPrimary && (
            <Badge
              className={`${theme === "dark" ? "bg-yellow-900/30 text-yellow-400 border-yellow-800" : "bg-yellow-100 text-yellow-700 border-yellow-200"}`}
            >
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return type ? (
        ...
        <span className={theme === "dark" ? "text-zinc-500" : "text-gray-400"}>
          -
        </span>
      );
    },
      ...
      return (
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            title={
              isPrimary
                ? "Cannot delete primary organization"
                : "Delete organization"
            }
          >
