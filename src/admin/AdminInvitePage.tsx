...
import { InvitedUser, createInvitedUsersColumns } from "./InvitedUsersColumns";

interface AdminInvitePageProps {
  onNavigate?: (page: string) => void;
}

export const AdminInvitePage: React.FC<AdminInvitePageProps> = ({
  onNavigate,
}) => {
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-auto px-8 py-6">
          ...
          {showSuccessAlert && (
            <Alert
              variant="success"
              className={`mb-6 ${theme === "dark" ? "bg-green-950/30 border-green-800" : "bg-green-50 border-green-200"}`}
            >
