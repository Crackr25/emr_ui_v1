...
const MOCK_ROLES: Role[] = [
  {
    ...
    role_name: "Member",
    role_description:
      "Default role for standard organization members with basic access",
    requires_npi: false,
  ...
  },
  {
    ...
    role_name: "Admin",
    role_description:
      "Administrative role with elevated permissions to manage users and settings",
    requires_npi: false,
    requires_license: false,
    created_at: "2024-01-15T10:00:00Z",
    updated_at: "2024-01-15T10:00:00Z",
  ...
  },
  {
    ...
    role_name: "Owner",
    role_description:
      "Organization owner with full control and all system permissions",
    requires_npi: false,
    requires_license: false,
    created_at: "2024-01-15T10:00:00Z",
    updated_at: "2024-01-15T10:00:00Z",
...
export const AdminRolesPage: React.FC<AdminRolesPageProps> = ({
  ...
  const [selectedRoleForPolicies, setSelectedRoleForPolicies] =
  ...
  const handleAddRole = (roleData: RoleFormData) => {
    if (editingRole) {
      ...
      setRoles(
        roles.map((r) => (r.role_id === editingRole.role_id ? updatedRole : r)),
      );
